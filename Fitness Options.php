    ...
    <div id="exercisesec">
        ...
        <div id="cardioinfo">
            ...
            <div style="margin-right: 20px;">
                <img src="cardio.webp" style="width: 300px; margin-top: 20px;">
            </div>
        ...
        <div id="strengthinfo">
            ...
            <div style="margin-right: 20px;">
                <img src="strength.webp" style="width: 300px; margin-top: 20px;">
            </div>
        ...
        <div id="mindbodyinfo">
            ...
            <div style="margin-right: 20px;">
                <img src="mind and body.webp" style="width: 300px; margin-top: 20px;">
            </div>
        ...
        <div id="aquainfo">
            ...
            <div style="margin-right: 20px;">
                <img src="swimmingpool.jpg" style="width: 300px; margin-top: 20px;">
            </div>
